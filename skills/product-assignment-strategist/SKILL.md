...
- In Vite React projects, keep `app/` focused on bootstrapping, providers, router setup, and global styles. Put real page composition in `views/` or the existing project page layer.
...
- Prefer explicit view models and domain names over generic abstractions when that makes reviewer understanding faster.
